						...
						<div class="book-grid">
							...
							<div>
								...
								<div style="background: #F1F5F9; padding: 18px; border-radius: 12px; display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; margin: 20px 0; gap: 10px;">
									...
									<a href="https://kakalif.jamia.id/buku" target="_blank" style="background: #0EA5E9; color: white; text-decoration: none; padding: 10px 20px; border-radius: 8px; font-size: 0.8rem; font-weight: bold;">Unduh PDF Resmi</a>
								</div>
